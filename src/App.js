    ...
    return (
      ...
      <div className="section-one">
        ...
        <p className="about-me col-small-12 ">
          Hi. I'm Candice. I write code, I sleep code, I eat code, and I drink diet code. For the last three years I've worked as a graphic designer while learning to code as a passion project. Back when all this was just a hobby, I mostly worked with vanilla JavaScript. Gradually, I became more obsessed with learning JavaScript and eventually enrolled at DecodeMTL where I learned back-end and front-end. On the front-end, I've worked with vanilla JavaScript, jQuery, HTML/CSS and React; on the back-end, I've used
          Node.JS, mySQL, RESTful APIs and Express. The things that attracted me to coding in the first place still remain my raison d'être - a deep love for strong logic, clean code and expanding my knowledge through learning and practice as I strive to continually improve.
        </p>
      </div>
      ...
      <div className="section-three project-row">
        <h3><p className="contact-me col-small-12">CONTACT</p></h3>
        <p className="email-me col-small-12">
